...
exports.EnhancementType = void 0;
// src/app.ts
const axios_1 = __importDefault(require("axios"));
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
const dotenv_1 = __importDefault(require("dotenv")); // Use ES6 import style
...
(function (EnhancementType) {
    EnhancementType["AddComments"] = "AddComments";
    EnhancementType["Analyze"] = "Analyze";
    EnhancementType["Explain"] = "Explain";
...
function isValidEnhancementType(value) {
    return Object.values(EnhancementType).includes(value);
}
if (!API_KEY) {
...
// --- Prompt Generation ---
function generatePrompt(enhancement, code) {
...
async function callGeminiApi(promptText) {
    ...
    try {
        const response = await axios_1.default.post(GEMINI_API_ENDPOINT, requestData, config);
...
async function main() {
    ...
    const enhancementType = requestedEnhancement; // Type assertion is safe now
